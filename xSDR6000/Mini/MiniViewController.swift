...
final class MiniViewController: NSViewController {
    ...
    private weak var _delegate                      : MainWindowController?
    ...
    private func addNotifications() {
        NCtr.makeObserver(self, with: #selector(sliceChange(_:)), of: .sliceHasBeenAdded)
        NCtr.makeObserver(self, with: #selector(sliceChange(_:)), of: .sliceBecameActive)
    }

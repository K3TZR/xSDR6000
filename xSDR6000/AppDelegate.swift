...
//  // Log parameters
//  static let kLoggerName                    = Logger.kName
...
//  }()
  ...
  ///
//  public func logMessage(_ msg: String, _ level: MessageLevel, _ function: StaticString, _ file: StaticString, _ line: Int, _ source: String = kName ) -> Void {
//
